        ...
        for (int i = 0; i < board.length; i++) {
          for (int j = 0; j < board[i].length; j++) {
            ...
            if (board[i][j] == 2) {
              ...
              if (facing == 1) image(Playerright[Enemy_num],i*gridSize + gridSize/2-15, j*gridSize + gridSize/2-15,Playerright[Enemy_num].width,Playerright[Enemy_num].height);
              if (facing == 3) image(Playerleft[Enemy_num],i*gridSize + gridSize/2-15, j*gridSize + gridSize/2-15,Playerleft[Enemy_num].width,Playerleft[Enemy_num].height);
            }
