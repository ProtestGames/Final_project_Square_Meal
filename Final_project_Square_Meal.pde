...
PImage[] Enemyleft = new PImage[10];
PImage[] Enemyright = new PImage[10];
PImage[] Playerleft = new PImage[10];
PImage[] Playerright = new PImage[10];
PImage[] mirleft = new PImage[6];
PImage[] mirright = new PImage[6];
